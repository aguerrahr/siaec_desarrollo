<?php
    ...
    */
    ...
    ##  *** 2. write the primary key in the first place (MUST BE AUTO-INCREMENT NUMERIC!)
      $sql = "
            SELECT
              ...
              Est_UsuDesc
            FROM est";
      $default_order = array('Est_UsuDesc'=>'ASC');   /* Ex.: array('field_1'=>'ASC', 'field_2'=>'DESC') */
    ...
    ##  *** 'byFieldValue'=>'fieldName' - make the field to be a link to edit mode page
     $modes = array(
        'add'	  =>array('view'=>true, 'edit'=>true, 'type'=>'image',  'show_button'=>true, 'show_add_button'=>'inside|outside'),
        'edit'	  =>array('view'=>true, 'edit'=>true,  'type'=>'image',  'show_button'=>true, 'byFieldValue'=>''),
        'details' =>array('view'=>true, 'edit'=>true, 'type'=>'image',  'show_button'=>true),
    ...
    ##  *** set DataGrid caption
     $dg_caption = 'Cat&aacute;logo Estatus';
    ...
    /// $fill_from_array = array('0'=>'Banned', '1'=>'Active', '2'=>'Closed', '3'=>'Removed'); /* as 'value'=>'option' */
     $vm_columns = array(
         'IdEst'=>array('header'=>'IdEst', 'type'=>'label','align'=>'left', 'width'=>'X%|Xpx', 'wrap'=>'wrap|nowrap', 'text_length'=>'-1', 'tooltip'=>'false', 'tooltip_type'=>'floating|simple', 'case'=>'normal|upper|lower|camel', 'summarize'=>'false', 'summarize_sign'=>'', 'sort_type'=>'string|numeric', 'sort_by'=>'', 'visible'=>'false', 'on_js_event'=>''),
         'Est_UsuDesc'=>array('header'=>'Estatus', 'type'=>'label','align'=>'left', 'width'=>'X%|Xpx', 'wrap'=>'wrap|nowrap', 'text_length'=>'-1', 'tooltip'=>'false', 'tooltip_type'=>'floating|simple', 'case'=>'normal|upper|lower|camel', 'summarize'=>'false', 'summarize_sign'=>'', 'sort_type'=>'string|numeric', 'sort_by'=>'', 'visible'=>'true', 'on_js_event'=>''),
    ...
    /// $fill_from_array = array('0'=>'No', '1'=>'Yes', '2'=>'Don\'t know', '3'=>'My be'); /* as 'value'=>'option' */
     $em_columns = array(
         'Est_UsuDesc'  =>array('header'=>'Estatus', 'type'=>'textbox',    'req_type'=>'rt', 'width'=>'210px', 'title'=>'', 'readonly'=>'false', 'maxlength'=>'-1', 'default'=>'', 'unique'=>'false', 'unique_condition'=>'', 'visible'=>'true', 'on_js_event'=>''),
    ...
    ##  *** Ex.: 'on_js_event'=>'onclick="alert(\'Yes!!!\');"'
    /// $foreign_keys = array(
    ///     'plan_idest'=>array('table'=>'est', 'field_key'=>'IdEst', 'field_name'=>'Est_UsuDesc', 'view_type'=>'dropdownlist(default)|radiobutton|textbox|label',
    /// 'elements_alignment'=>'horizontal|vertical', 'condition'=>'', 'order_by_field'=>'Est_UsuDesc', 'order_type'=>'ASC', 'show_count'=>'', 'on_js_event'=>''),
