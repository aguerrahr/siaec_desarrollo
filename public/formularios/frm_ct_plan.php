<?php
    ...
    */
    ...
    ################################################################################
    ## --------------------------------------------------------------------------- #
    ##  ApPHP DataGrid Pro (AJAX enabled) version 8.2.7                            #
    ...
    ##  *** creating variables that we need for database connection
      ...
      $DB_PASS=DBPASS;            /* don't use empty passwords (recommended)    */
    ...
    ##  *** set needed options and create a new class instance
     ...
     $unique_prefix = 'siaec_';    /* prevent overlays - must be started with a letter */
    ...
    ##  *** set encoding and collation (default: utf8/utf8_unicode_ci)
     ...
     ## Inicia Botones
      $a_btn_open ='<a class="Ntooltip">';
      $a_btn_close = '</a>';
      $id_btn = '" id="Btn_Eliminar_Reg"';
     ## Inicia Botón Eliminar
      $open_btn_Eliminar = '<img class="btn" src="images/delete.gif" onclick="set_EliminaRegistro(';
      $close_btn_Eliminar = '"/>';
      $open_tooltip_Eliminar = '<span id = "span_ev';
      $close_tooltip_Eliminar = '">Eliminar Registro</span>';
    ## Termina Botón Eliminar
    ...
    ##  *** 2. write the primary key in the first place (MUST BE AUTO-INCREMENT NUMERIC!)
      $sql = "
            SELECT
              ...
              plan.plan_desc,
              est.Est_UsuDesc,
concat('".$a_btn_open.$open_btn_Eliminar."',Idplan,')".$id_btn.$close_btn_Eliminar.$open_tooltip_Eliminar.$close_tooltip_Eliminar.$a_btn_close."') as Eliminar
            FROM plan
            INNER JOIN est
            ON plan.plan_idest = est.IdEst";
      $default_order = array('plan_desc'=>'ASC');   /* Ex.: array('field_1'=>'ASC', 'field_2'=>'DESC') */
    ...
    ##  *** 'byFieldValue'=>'fieldName' - make the field to be a link to edit mode page
     $modes = array(
        'add'	  =>array('view'=>true, 'edit'=>false, 'type'=>'image',  'show_button'=>true, 'show_add_button'=>'inside|outside'),
        'edit'	  =>array('view'=>true, 'edit'=>true,  'type'=>'image',  'show_button'=>true, 'byFieldValue'=>''),
        'details' =>array('view'=>true, 'edit'=>false, 'type'=>'image',  'show_button'=>true),
    ...
    ##  *** 'default|blue|gray|green|pink|empty|x-blue|x-gray|x-green' or your own css style
     $css_class = 'x-graphite';
     $dgrid->SetCssClass($css_class);
    ##  *** set DataGrid caption
     $dg_caption = 'Cat&aacute;logo planteles';
    ...
    /// $fill_from_array = array('0'=>'Banned', '1'=>'Active', '2'=>'Closed', '3'=>'Removed'); /* as 'value'=>'option' */
     $vm_columns = array(
         'Idplan'=>array('header'=>'Id_plan', 'type'=>'label',      'align'=>'left', 'width'=>'X%|Xpx', 'wrap'=>'wrap|nowrap', 'text_length'=>'-1', 'tooltip'=>'false', 'tooltip_type'=>'floating|simple', 'case'=>'normal|upper|lower|camel', 'summarize'=>'false', 'summarize_sign'=>'', 'sort_type'=>'string|numeric', 'sort_by'=>'', 'visible'=>'false', 'on_js_event'=>''),
         'plan_desc'=>array('header'=>'Plantel', 'type'=>'label',      'align'=>'left', 'width'=>'X%|Xpx', 'wrap'=>'wrap|nowrap', 'text_length'=>'-1', 'tooltip'=>'false', 'tooltip_type'=>'floating|simple', 'case'=>'normal|upper|lower|camel', 'summarize'=>'false', 'summarize_sign'=>'', 'sort_type'=>'string|numeric', 'sort_by'=>'', 'visible'=>'true', 'on_js_event'=>''),
         'Est_UsuDesc'=>array('header'=>'Estado', 'type'=>'label',      'align'=>'left', 'width'=>'X%|Xpx', 'wrap'=>'wrap|nowrap', 'text_length'=>'-1', 'tooltip'=>'false', 'tooltip_type'=>'floating|simple', 'case'=>'normal|upper|lower|camel', 'summarize'=>'false', 'summarize_sign'=>'', 'sort_type'=>'string|numeric', 'sort_by'=>'', 'visible'=>'true', 'on_js_event'=>''),
         'Eliminar'=>array('header'=>'Eliminar', 'type'=>'label_clck_row', 'align'=>'center', 'width'=>'100px', 'wrap'=>'wrap|nowrap', 'text_length'=>'-1', 'tooltip'=>'false', 'tooltip_type'=>'floating|simple', 'case'=>'normal|upper|lower|camel', 'summarize'=>'false', 'summarize_sign'=>'', 'sort_type'=>'string|numeric', 'sort_by'=>'', 'visible'=>'true', 'on_js_event'=>''),
    ...
    /// $fill_from_array = array('0'=>'No', '1'=>'Yes', '2'=>'Don\'t know', '3'=>'My be'); /* as 'value'=>'option' */
     $em_columns = array(
         'plan_desc'  =>array('header'=>'Plantel', 'type'=>'textbox',    'req_type'=>'rt', 'width'=>'210px', 'title'=>'', 'readonly'=>'false', 'maxlength'=>'-1', 'default'=>'', 'unique'=>'false', 'unique_condition'=>'', 'visible'=>'true', 'on_js_event'=>''),
         'plan_idest' =>array('header'=>'Estado', 'type'=>'foreign_key','req_type'=>'ri', 'width'=>'', 'title'=>'', 'readonly'=>'false', 'default'=>'', 'unique'=>'false', 'unique_condition'=>'', 'visible'=>'true'),
         'plan_fechalt' =>array('header'=>'plan_fechalt', 'type'=>'hidden',     'req_type'=>'st', 'default'=>'NOW()', 'value'=>'', 'unique'=>'false', 'visible'=>'false'),
    ...
    ##  *** Ex.: 'on_js_event'=>'onclick="alert(\'Yes!!!\');"'
     $foreign_keys = array(
         'plan_idest'=>array('table'=>'est', 'field_key'=>'IdEst', 'field_name'=>'Est_UsuDesc', 'view_type'=>'dropdownlist(default)|radiobutton|textbox|label', 'elements_alignment'=>'horizontal|vertical', 'condition'=>'', 'order_by_field'=>'Est_UsuDesc', 'order_type'=>'ASC', 'show_count'=>'', 'on_js_event'=>''),
...
<head>
    ...
    <title>Catálogo planteles</title>
    <script src="../js/jquery-3.4.0.min.js"></script>
    <script src="../js/ui-ct-plan.js"></script>
    <?php
...
<?php
    ...
    //$pid = (isset($_REQUEST[$unique_prefix.'pid'])) ? $_REQUEST[$unique_prefix.'pid'] : '';
     ...
     //echo "El modo es: " . $mode . "<br/>";
     //echo "El RowId es: ". $rid. "<br/>";;
     //echo "El Id es: ".$pid. "<br/>";;
