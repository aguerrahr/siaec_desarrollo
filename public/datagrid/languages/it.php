...
function setLanguageIt(){ 
    ...
    $lang['export_message'] = "<label class=\"default_class_label\">Il file _FILE_ è pronto. Dopo avere finito il download,</label> <a class=\"default_class_error_message\" href=\"javascript: window.close();\">Chiudi la finestra</a>.";
    $lang['field'] = "Campo"; 
